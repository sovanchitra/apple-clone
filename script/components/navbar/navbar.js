export class NavBar extends HTMLElement{
    ...
    connectedCallback(){
            ...
            <div class="max-w-screen-lg w-full flex justify-between md:justify-evenly gap-8 py-2 px-3">
                <div class="flex w-[2%]">
                    <a href="/pages/homepage/homepage.html">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" id="apple-logo" class="w-5 h-5 md:w-4 md:w-4" viewBox="0 0 16 16">
                ...
                <ul class="md:flex w-[92%] items-center justify-between font-light text-xs hidden">
                    <li class="group">
                        ...
                        <div class="hidden group-hover:block absolute z-10 left-0 w-screen h-fit bg-gray-100 shadow-xl py-10">
                ...
                <div class="flex w-24 md:w-[6%] items-center justify-between">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="black" id="search-icon" class="w-4 h-4 md:w-3.5 md:w-3.5" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="black" id="cart-icon" class="w-4 h-4 md:w-3.5 md:w-3.5" viewBox="0 0 16 16">
        ...
        <div id="mobile-navbar" class="hidden z-20 md:hidden fixed flex flex-col top-9 w-screen h-screen bg-gray-100 text-2xl font-medium text-gray-800 gap-3 px-12 pt-12">
            <a href="#">Store</a>
            <a href="#">iPad</a>
            <a href="#">iPhone</a>
            <a href="#">Watch</a>
    ...
    toggleMobileNavbar() {
        ...
        if (navbarVisible) {
            ...
            barOne.classList.add("rotate-45", "translate-y-1");
            barTwo.classList.add("-rotate-45", "-translate-y-0.5");
            appleLogo.classList.add("opacity-0");
            searchIcon.classList.add("opacity-0");
            cartIcon.classList.add("opacity-0");
        } else {
            mobileNavbar.classList.add("hidden");
            barOne.classList.remove("rotate-45", "translate-y-1");
            barTwo.classList.remove("-rotate-45", "-translate-y-0.5");
